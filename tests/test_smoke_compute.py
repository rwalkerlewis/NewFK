...
from fkpy.greens import compute_greens, compute_single_force_greens
...
@pytest.mark.fast
def test_compute_single_force_greens_smoke(two_layer_model) -> None:
    ...
    # 2 distances × 6 SF components (n=0,1 × Z,R,T) × 128 samples
